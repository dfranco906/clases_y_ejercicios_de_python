...
# para los humanos, conceptualmente ambas variables son lo mismo
...
# Pascal Case: la primera letra de cada palabra en mayusculas, se utilizan mas
# para nombrar funciones
NombreApellido = "Perla Torres"

# Snake Case: las palabras van separadas por guiones bajos
nombre_apellido = "Perla Torres"
